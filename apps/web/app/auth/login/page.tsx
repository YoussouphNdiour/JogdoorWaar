    ...
    <div className="min-h-screen bg-sand flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-soft border border-sand-dark">
          ...
          <a
            href={`${process.env.NEXT_PUBLIC_API_URL ?? 'https://jdw-api-ubi5.onrender.com'}/auth/linkedin`}
            className="w-full flex items-center justify-center gap-3 border border-sand-dark py-3 rounded-xl font-dm text-sm text-savane hover:bg-sand-dark transition-colors mt-3"
          >
